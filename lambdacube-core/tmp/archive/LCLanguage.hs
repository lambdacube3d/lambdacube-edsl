...
texture'                      a b c = PrimApp PrimTexture               $! tup3 (a,b,c)
textureProj'                  a b c = PrimApp PrimTextureProj           $! tup3 (a,b,c)
textureLod'                   a b c = PrimApp PrimTextureLod            $! tup3 (a,b,c)
textureOffset'              a b c d = PrimApp PrimTextureOffset         $! tup4 (a,b,c,d)
texelFetch'                   a b c = PrimApp PrimTexelFetch            $! tup3 (a,b,c)
texelFetchOffset'           a b c d = PrimApp PrimTexelFetchOffset      $! tup4 (a,b,c,d)
textureProjOffset'          a b c d = PrimApp PrimTextureProjOffset     $! tup4 (a,b,c,d)
